...
public final class DistanceFunctions {
	...
	public interface EuclideanCoordinate {
        ...
        public static double upperBoundMeanVariance(EuclideanCoordinate coord1, EuclideanCoordinate coord2){
//            return Math.sqrt((coord1.get(0)-coord2.get(0))*(coord1.get(0)-coord2.get(0))
//                    + (coord1.get(1) + coord2.get(1))*(coord1.get(1) + coord2.get(1)));
            
            double sum=0;
            int dims = coord1.dimensions();
            for(int i=0; i< dims/2;i++){
                sum += Math.pow(coord1.get(i*2)-coord2.get(i*2),2)+Math.pow(coord1.get(i*2+1)+coord2.get(i*2+1),2);
            }
	...
	public static double euclidean(EuclideanCoordinate coord1, EuclideanCoordinate coord2) {
            DoubleMTree.numRealDistanceCall++;
        ...
        public static final DistanceFunction<EuclideanCoordinate> UPPERBOUND = new DistanceFunction<DistanceFunctions.EuclideanCoordinate>() {
		@Override
		public double calculate(EuclideanCoordinate coord1, EuclideanCoordinate coord2) {
			return DistanceFunctions.upperBoundMeanVariance(coord1, coord2);
		}
	};
